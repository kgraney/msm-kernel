...
struct task_struct {
	...
	unsigned int ptrace;
	unsigned int fault_countdown; /* number of system calls until a fault should happen */
#ifdef CONFIG_SMP
...
#define PF_FAULT_INJECTION  0x80000000  /* System call fault injection is active (tsk->fault_countdown is valid) */
/*
